(function()
{
    ...
    B.Tools.Colors = B.Core.Abstract.extend(
    {
        ...
        options :
        {
            hexa_authorized_chars : '0123456789abcdef',
            names :
            {
                'aliceblue'            : 'F0F8FF',
                'antiquewhite'         : 'FAEBD7',
        ...
        any_to_rgb : function( any )
        {
            ...
            // Name
            if( typeof this.options.names[ any ] !== 'undefined' )
            {
                return this.hexa_to_rgb( this.options.names[ any ] );
            }
            ...
            if( any.indexOf( '#' ) === 0 )
            {
                return this.hexa_to_rgb( any.replace( '#', '' ) );
            }
